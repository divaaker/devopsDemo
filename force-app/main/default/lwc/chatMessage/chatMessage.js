...
const SUPPORTED_MESSAGE_PREFIX = [UPLOAD_PREFIX, DEFAULT_MESSAGE_PREFIX, RICHTEXT_MESSAGE_PREFIX, YOUTUBE_MESSAGE_PREFIX, IMAGE_MESSAGE_PREFIX, URL_MESSAGE_PREFIX, NAVIGATE_MESSAGE_PREFIX, VIMEO_MESSAGE_PREFIX];
...
export default class ChatMessageDefaultUI extends BaseChatMessage {
    ...
    connectedCallback() {
        ...
        if (this.isPlainText) {
            ...
            this.content = this.extractOriginalUrl(contentValue);
             ...
             this.myRecordId = this.inputParams.split(':')[1];
        }
         else if (this.isUrl) {
            this.content = this.extractOriginalUrl(contentValue);
    ...
    get isUpload() {
        return this.messageType === UPLOAD_PREFIX;
    }
